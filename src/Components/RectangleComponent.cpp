...
RectangleComponent::RectangleComponent(QObject *parent)
{
...
void RectangleComponent::createRectangleBuffer(std::vector<GLfloat> *buffer)
{
    /*
...
void RectangleComponent::createRectangleBuffer_multithreaded(std::vector<GLfloat> *buffer)
{
    qDebug() << "Creating rectangle buffer...";
...
void RectangleComponent::setAttributs()
{
...
void RectangleComponent::bindAttributs()
{
...
void RectangleComponent::initializeShaders()
{
    setAttributs();
...
void RectangleComponent::loadTexture()
{
...
// void RectangleComponent::keyPressEvent(QKeyEvent *event)
// {
...
// void RectangleComponent::keyReleaseEvent(QKeyEvent *event)
// {
...
void RectangleComponent::keyHandler()
{
...
void RectangleComponent::renderScene()
{
...
void RectangleComponent::renderMainScene()
{
...
void RectangleComponent::renderZoomScene()
{
    int zoomViewportWidth = width() / 4;                  // 1/4th of the screen width
    int zoomViewportHeight = height() / 4;                // 1/4th of the screen height
    int zoomViewportX = width() - zoomViewportWidth - 10; // Bottom-right corner (with padding)
...
void RectangleComponent::setObjectPosition(const QVector3D &position)
{
...
float RectangleComponent::rotate() const
{
    return m_rotate;
}
...
void RectangleComponent::setRotate(float angle)
{
    if (m_rotate != angle)
    {
        m_rotate = angle;
...
float RectangleComponent::scale() const
{
    return m_scale;
}
...
void RectangleComponent::setScale(float scale)
{
...
bool RectangleComponent::useTexture() const
{
    return m_useTexture;
}
...
void RectangleComponent::setUseTexture(bool use)
{
    if (m_useTexture != use)
    {
        m_useTexture = use;
...
void RectangleComponent::render()
{
    ...
    qDebug() << "Rendering with size:" << width() << "x" << height();
    renderMainScene();
    renderZoomScene();
...
QVector3D RectangleComponent::objectPosition() const
{
...
void RectangleComponent::printBuffer(std::vector<GLfloat> buffer)
{
    // qDebug() <<buffer;
